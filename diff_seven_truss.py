...
class Truss_Analysis(Group):
    ...
    def setup(self):
        ...
        indeps.add_output("n1_beam4", math.pi * 5 / 3, units = "rad", desc = "Direction of beam 4 at node 1")
        ...
        indeps.add_output("n2_beam5", math.pi * 4 / 3, units = "rad", desc = "Direction of beam 5 at node 2")
        indeps.add_output("n2_beam6", math.pi / 2, units = "rad", desc = "Direction of beam 6 at node 2")
        indeps.add_output("n3_beam4", math.pi * 2 / 3, units = "rad", desc = "Direction of beam 4 at node 3")
        indeps.add_output("n3_beam5", math.pi * 1 / 3, units = "rad", desc = "Direction of beam 5 at node 3")
        ...
        self.connect("cycle.beam4.beam_force", ["cycle.node1.load_in3", "cycle.node3.load_in0"])
        self.connect("cycle.beam5.beam_force", ["cycle.node2.load_in1", "cycle.node3.load_in1"])
        self.connect("cycle.beam6.beam_force", ["cycle.node2.load_in2", "cycle.node4.load_in2"])
