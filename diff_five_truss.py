...
class Truss_Analysis(Group):
    ...
    def setup(self):
        ...
        indeps.add_output("n0_beam0", math.pi * 7 / 4, units = "rad", desc = "Direction of beam 0 at node 0")
        ...
        indeps.add_output("n1_beam3", math.pi * 5 / 3, units = "rad", desc = "Direction of beam 3 at node 1")
        indeps.add_output("n2_beam3", math.pi * 2 / 3, units = "rad", desc = "Direction of beam 2 at node 2")
        indeps.add_output("n2_beam4", math.pi / 3, units = "rad", desc = "Direction of beam 4 at node 2")
        indeps.add_output("n3_beam4", math.pi * 5 / 3, units = "rad", desc = "Direction of beam 4 at node 3")
        indeps.add_output("n3_beam2", math.pi, units = "rad", desc = "Direction of beam 5 at node 3")
        indeps.add_output("n3_beam0", math.pi * 3 / 4, units = "rad", desc = "Direction of beam 0 at node 4")
        ...
        self.add_subsystem("obj_cmp", ExecComp("obj = L1 * (A3 + A1 + A2 + A4) + L2 * A0"))
