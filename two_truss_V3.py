...
class Truss_Analysis(Group):
    ...
    def setup(self):
        ...
        indeps.add_output("n1_x_reaction_direction", 0, units = "rad", desc = "Direction of reaction force of pinnned joint on node 1")
        indeps.add_output("n1_y_reaction_direction", math.pi / 2, units = "rad", desc = "Direction of reaction force of pinned joint on node 1")
        indeps.add_output("n0_beam0", math.pi * 11 / 6, units = "rad", desc = "Direction of beam 0 at node 0")
        indeps.add_output("n1_beam1", math.pi / 6, units = "rad", desc = "Direction of beam 1 at node 1")
        indeps.add_output("n2_beam0", math.pi * 5 / 6, units = "rad", desc = "Direction of beam 0 at node 2")
        indeps.add_output("n2_beam1", math.pi * 7 / 6, units = "rad", desc = "Direction of beam 1 at node 2")
        ...
        cycle.add_subsystem("node0", Node(n_loads = 1, n_reactions = 2))
        cycle.add_subsystem("node1", Node(n_loads = 1, n_reactions = 2))
        ...
        self.connect("indeps.n1_y_reaction_direction", "cycle.node1.direction1_reaction")
        self.connect("indeps.n1_beam1", "cycle.node1.direction0_load")
        #Node 2 connections
        self.connect("indeps.n2_beam0", "cycle.node2.direction0_load")
        self.connect("indeps.n2_beam1", "cycle.node2.direction1_load")
        ...
        self.connect("cycle.node1.load_out0", "cycle.beam1.force0")
        self.connect("cycle.node2.load_out1", "cycle.beam1.force1")
        ...
        self.connect("cycle.beam1.beam_force", ["cycle.node2.load_in1", "cycle.node1.load_in0"])
...
if __name__ == "__main__":
    ...
    print("n1_y_reaction", prob["cycle.node1.reaction1"])