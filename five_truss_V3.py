...
class Truss_Analysis(Group):
    ...
    def setup(self):
        ...
        indeps.add_output("n0_beam0", 0, units = "rad", desc = "Direction of truss 0 at node 0")
        indeps.add_output("n0_beam1", math.pi * 3 / 2, units = "rad", desc = "Direction of truss 1 at node 0")
        indeps.add_output("n1_beam1", math.pi / 2, units = "rad", desc = "Direction of truss 1 at node 1")
        indeps.add_output("n1_beam2", 0, units = "rad", desc = "Direction of truss 2 at node 1")
        indeps.add_output("n1_beam3", math.pi / 4, units = "rad", desc = "Direction of truss 3 at node 1")
        indeps.add_output("n2_beam2", math.pi, units = "rad", desc = "Direction of truss 2 at node 2")
        indeps.add_output("n2_beam4", math.pi / 2, units = "rad", desc = "Direction of truss 4 at node 2")
        indeps.add_output("n3_beam0", math.pi, units = "rad", desc = "Direction of truss 0 at node 3")
        indeps.add_output("n3_beam3", math.pi * 5 / 4, units = "rad", desc = "Direction of truss 3 at node 3")
        indeps.add_output("n3_beam4", math.pi * 3 / 2, units = "rad", desc = "Direction of truss 4 at node 3")
        ...
        cycle.add_subsystem("node0", Node(n_loads = 4))
        cycle.add_subsystem("node1", Node(n_loads = 4))
        cycle.add_subsystem("node2", Node(n_loads = 2, n_external_forces = 1))
        cycle.add_subsystem("node3", Node(n_loads = 3))
        cycle.add_subsystem("truss0", Truss())
        cycle.add_subsystem("truss1", Truss())
        cycle.add_subsystem("truss2", Truss())
        cycle.add_subsystem("truss3", Truss())
        cycle.add_subsystem("truss4", Truss())
        ...
        self.connect("cycle.node0.load2_out", "cycle.truss0.force0")
        self.connect("cycle.node0.load3_out", "cycle.truss1.force0")
        self.connect("cycle.node1.load1_out", "cycle.truss1.force1")
        self.connect("cycle.node1.load2_out", "cycle.truss2.force0")
        self.connect("cycle.node1.load3_out", "cycle.truss3.force0")
        self.connect("cycle.node2.load0_out", "cycle.truss2.force1")
        self.connect("cycle.node2.load1_out", "cycle.truss4.force0")
        self.connect("cycle.node3.load0_out", "cycle.truss0.force1")
        self.connect("cycle.node3.load1_out", "cycle.truss3.force1")
        self.connect("cycle.node3.load2_out", "cycle.truss4.force1")
        self.connect("cycle.truss0.beam_force", ["cycle.node0.load2_in", "cycle.node3.load0_in"])
        self.connect("cycle.truss1.beam_force", ["cycle.node0.load3_in", "cycle.node1.load1_in"])
        self.connect("cycle.truss2.beam_force", ["cycle.node1.load2_in", "cycle.node2.load0_in"])
        self.connect("cycle.truss3.beam_force", ["cycle.node1.load3_in", "cycle.node3.load1_in"])
        self.connect("cycle.truss4.beam_force", ["cycle.node2.load1_in", "cycle.node3.load2_in"])
