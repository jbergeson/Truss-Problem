...
class Truss_Analysis(Group):
    ...
    def setup(self):
        ...
        self.connect("indeps.n3_beam3", "cycle.node3.direction1_load")
        ...
        self.connect("cycle.node3.load_out1", "cycle.beam3.force1")
        ...
        self.connect("cycle.beam3.beam_force", ["cycle.node1.load_in2", "cycle.node3.load_in1"])
