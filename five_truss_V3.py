...
class Truss_Analysis(Group):
    ...
    def setup(self):
        ...
        cycle.add_subsystem("node0", Node(n_forces_out = 2, n_forces_in = 2))
        cycle.add_subsystem("node1", Node(n_forces_out = 2, n_forces_in = 2))
        cycle.add_subsystem("node2", Node(n_forces_out = 2, n_forces_in = 0, n_external_forces = 1))
        cycle.add_subsystem("node3", Node(n_forces_out = 2, n_forces_in = 1))
        ...
        self.connect("indeps.n0_truss1", "cycle.node0.direction1_in")
        #Node 1 connections
        self.connect("indeps.n1_x_reaction", "cycle.node1.direction0_out")
        self.connect("indeps.n1_truss1", "cycle.node1.direction1_out")
        self.connect("indeps.n1_truss2", "cycle.node1.direction0_in")
        self.connect("indeps.n1_truss3", "cycle.node1.direction1_in")
        #Node 2 connections
        ...
        self.connect("indeps.n3_truss4", "cycle.node3.direction0_in")
        #Inter-node connections
        self.connect("cycle.node1.force1_out", ["cycle.node0.force1_in", "truss1.P"])
        self.connect("cycle.node2.force0_out", ["cycle.node1.force0_in", "truss2.P"])
        self.connect("cycle.node2.force1_out", ["cycle.node3.force0_in", "truss4.P"])
        self.connect("cycle.node3.force0_out", ["cycle.node0.force0_in", "truss0.P"])
        self.connect("cycle.node3.force1_out", ["cycle.node1.force1_in", "truss3.P"])
