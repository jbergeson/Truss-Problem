...
class Truss_Analysis(Group):
    ...
    def setup(self):
        ...
        cycle.add_subsystem("node0", Node(n_new_forces = 4))
        cycle.add_subsystem("node1", Node(n_new_forces = 3, n_old_forces = 1))
        cycle.add_subsystem("node2", Node(n_new_forces = 1, n_old_forces = 1, n_external = 1))
        cycle.add_subsystem("node3", Node(n_old_forces = 3))
        ...
        #Node 0 connections
        self.connect("indeps.n0_x_reaction", "cycle.node0.direction0_new")
        self.connect("indeps.n0_y_reaction", "cycle.node0.direction1_new")
        self.connect("indeps.n0_truss0", "cycle.node0.direction2_new")
        self.connect("indeps.n0_truss1", "cycle.node0.direction3_new")
        #Node 1 connections
        self.connect("indeps.n1_x_reaction", "cycle.node1.direction0_new")
        self.connect("indeps.n1_truss1", "cycle.node1.direction0_old")
        self.connect("indeps.n1_truss2", "cycle.node1.direction1_new")
        self.connect("indeps.n1_truss3", "cycle.node1.direction2_new")
        #Node 2 connections
        self.connect("indeps.n2_truss2", "cycle.node2.direction0_old")
        self.connect("indeps.n2_truss4", "cycle.node2.direction0_new")
        self.connect("indeps.ext_direction", "cycle.node2.external_direction0")
        self.connect("indeps.ext", "cycle.node2.external_force0")
        #Node 3 connections
        self.connect("indeps.n3_truss0", "cycle.node3.direction0_old")
        self.connect("indeps.n3_truss3", "cycle.node3.direction1_old")
        self.connect("indeps.n3_truss4", "cycle.node3.direction2_old")
        #Inter-node connections
        self.connect("cycle.node0.force3_new", ["cycle.node1.force0_old", "truss1.P"])
        self.connect("cycle.node0.force2_new", ["cycle.node3.force0_old", "truss0.P"])
        self.connect("cycle.node1.force1_new", ["cycle.node2.force0_old", "truss2.P"])
