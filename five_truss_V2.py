import math
import numpy as np 
from three_truss_V2 import truss, Node
...
class Truss_Analysis(Group):
    ...
    def setup(self):
        ...
        indeps.add_output("x_reaction_n1", F, units = "N", desc = "Horizontal reaction force of pinnned joint on node 1")
        ...
        indeps.add_output("reaction_n2", F, units = "N", desc = "Horizontal reaction force of pinnned joint on node 2")
        ...
        indeps.add_output("truss5_n3", math.pi / 2, units = "rad", desc = "Direction of truss5 at node3")
        ...
        self.add_subsystem("node3", Node(n_known = 2, n_unknown = 1, solve_first = "y"))
        truss1 = self.add_subsystem("truss1", truss())
        truss2 = self.add_subsystem("truss2", truss())
        truss3 = self.add_subsystem("truss3", truss())
        truss4 = self.add_subsystem("truss4", truss())
        truss5 = self.add_subsystem("truss5", truss())
