...
class Truss_Analysis(Group):
    ...
    def setup(self):
        ...
        indeps.add_output("n1_truss2", math.pi / 6, units = "rad", desc = "Direction of truss 2 at node 1")
        indeps.add_output("n2_truss2", math.pi * 7 / 6, units = "rad", desc = "Direction of truss 2 at node 2")
        ...
        self.add_subsystem("obj_cmp", ExecComp("obj = L1 * (A0 + A1 + A2)", A0 = 0.0, A1 = 0.0, A2 = 0.0, L1 = 1.0))
